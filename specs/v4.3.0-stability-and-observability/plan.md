...
### 当日验收
- [ ] 解散家庭 → `_operation_logs` 有完整 steps 记录
...
### 风险关注
- TTL 索引需要在 CloudBase 控制台手动配置（`_rate_limits.expireAt`）
...
| M4 可观测性 | 2026-04-24 上午 | _operation_logs / _rate_limits / patrolMemberOpenids 就位 |
