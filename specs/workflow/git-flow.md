...
- [ ] 更新 `project.config.json` 中的版本号（如适用）
- [ ] 确认所有 spec 的 `tasks.md` 状态为 ✅ 已完成
- [ ] 同步更新受影响的文档（详见「开发工作流」文档）
...
| 版本 | 日期 | 标签 | 主要内容 |
|------|------|------|----------|
| v1.0 | 2026-03-25 | — | 初始版本，核心记录功能 |
| v2.0 | 2026-03-27 | — | 全面重构、洞察趋势增强 |
| v3.0 | 2026-04-03 | — | 首页重设计、家庭协作、彩蛋系统 |
| v3.1 | 2026-04-08 | — | 暖色夜间模式、分享图 v2、性能优化 |
| v3.2.0 | 2026-04-10 | `v3.2.0` | 完整功能版本（首个 Git 管理版本） |
